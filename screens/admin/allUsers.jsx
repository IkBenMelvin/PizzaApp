...
const UserPage = ( {navigation} ) => {
  ...
  const headers = ["ID", "name", "email", "number", "street",  "postal", "created_at"];
  ...
  const renderRows = () => {
    ...
    return users.map((record) => (
      <View style={styles.tableRow} key={record.id}>
        ...
        <Text style={styles.rowText}>{record.email}</Text>
        <Text style={styles.rowText}>{record.number}</Text>
        <Text style={styles.rowText}>{record.street}</Text>
        <Text style={styles.rowText}>{record.postal}</Text>
